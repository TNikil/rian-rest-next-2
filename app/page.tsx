      ...
      <main id="top" className="max-w-[1100px] mx-auto px-5">
        ...
        <section className="pt-10 pb-10 grid md:grid-cols-[1.1fr_0.9fr] gap-10 items-center">
          <div className="order-2 md:order-1">
            ...
            <p className="text-[#2d3748] leading-relaxed text-base md:text-xl max-w-md font-bold italic">A clean, cozy apartment for families and solo travelers. SLTDA Approved sanctuary.</p>
        ...
        <section id="about" className="py-12 border-t border-black/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="p-6 border border-black/5 bg-white/30 rounded-3xl">
                ...
                <p className="text-[#4a5568] text-xs leading-relaxed font-semibold">Message us directly on WhatsApp for instant booking updates any time.</p>
              </div>
            </div>
        </section>
          ...
          <div className="grid lg:grid-cols-[1fr_380px] gap-8 items-start">
            ...
            <div className="space-y-4">
              <div className="rounded-[32px] border border-black/10 overflow-hidden h-[400px] bg-white/20 shadow-inner">
                <iframe src="https://www.google.com/maps/embed?pb=PLACEHOLDER3" 
            ...
            <div className="p-8 border border-black/10 bg-white/30 backdrop-blur-md rounded-[32px] shadow-lg">
              ...
              <p className="mt-8 text-[9px] text-[#4a5568] italic font-semibold border-t border-black/5 pt-4 text-center">
                * Estimated travel via local transport
              </p>
            </div>
          </div>
        </section>
