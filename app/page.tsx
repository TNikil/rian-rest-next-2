  ...
  return (
    <div className="min-h-screen text-[#1a1a1a] selection:bg-[#22c55e]/30 font-sans"
      ...
      <main id="top" className="max-w-[1100px] mx-auto px-5">
        ...
        {/* Location & Proximity Section - UPDATED IFRAME */}
          ...
          <div className="grid lg:grid-cols-[1fr_380px] gap-8 items-start">
            <div className="space-y-4">
              <div className="rounded-[32px] border border-black/10 overflow-hidden h-[450px] bg-white/20 shadow-inner">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3961.467431668817!2d79.87050017424683!3d6.834455819460295!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae25b0050fa7525%3A0x82290464dd52bdaf!2sRian%20rest!5e0!3m2!1sen!2slk!4v1715320000000!5m2!1sen!2slk" 
        ...
        <section id="contact" className="py-12 mb-20">
            <div className="max-w-xl mx-auto p-10 border border-black/5 bg-white/40 backdrop-blur-md rounded-[48px] text-center shadow-xl">
              <h2 className="text-3xl font-black mb-4 text-black">Ready to visit?</h2>
              <p className="text-[#4a5568] mb-8 font-semibold">Message us on WhatsApp and we’ll reply with availability and rates.</p>
              <a href={waLink} target="_blank" className="inline-block bg-[#22c55e] text-white px-12 py-5 rounded-full font-black text-lg hover:scale-105 transition shadow-xl">
                CHAT ON WHATSAPP
              </a>
